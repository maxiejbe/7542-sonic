...
public:
	...
	template <class T>
	static void BoostSerializable::serialize_save(const T& obj, std::string& outString)
	{
	...
	template <class T>
	static void BoostSerializable::serialize_load(T& dataOut, const void* data, const size_t dataSize)
	{
